...
const Sidebar = () => {
  return (
    <div className='text-white h-full w-[25%] p-2 flex-col' >
        ...
        <div className="bg-[#121212] h-[85%]  rounded">
              ...
              <div className="p-4 bg-[#242424] m-2 font-semibold flex flex-col items-start justify-start mt-4 gap-1 pl-4">
